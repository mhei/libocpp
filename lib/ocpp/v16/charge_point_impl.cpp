...
void ChargePointImpl::update_chargepoint_information(
    const std::string& vendor, const std::string& model, const NullOrOptionalString& serialnumber,
    const NullOrOptionalString& chargebox_serialnumber, const NullOrOptionalString& firmware_version,
    const NullOrOptionalString& iccid, const NullOrOptionalString& imsi, const NullOrOptionalString& meter_serialnumber,
    ...
    this->configuration->setChargepointInformation(vendor, model, serialnumber, chargebox_serialnumber,
                                                   firmware_version, iccid, imsi, meter_serialnumber, meter_type);
}
