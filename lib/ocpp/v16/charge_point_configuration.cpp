...
void ChargePointConfiguration::setChargepointInformation(
    const std::string& chargePointVendor, const std::string& chargePointModel,
    const NullOrOptionalString& chargePointSerialNumber, const NullOrOptionalString& chargeBoxSerialNumber,
    const NullOrOptionalString& firmwareVersion, const NullOrOptionalString& ICCID, const NullOrOptionalString& IMSI,
