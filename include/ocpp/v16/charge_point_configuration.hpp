...
public:
    ...
    void setChargepointInformation(const std::string& chargePointVendor, const std::string& chargePointModel,
                                   ...
                                   const NullOrOptionalString& firmwareVersion, const NullOrOptionalString& ICCID,
                                   const NullOrOptionalString& IMSI, const NullOrOptionalString& meterSerialNumber,
                                   const NullOrOptionalString& meterType);
